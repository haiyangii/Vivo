...
let vue= new Vue({
	...
	mounted:function(){
		 ono = localStorage.getItem("ono");
		 localStorage.setItem("pay",ono);
         axios.post("order",qs.stringify({op:"findByOno",ono:ono})).then(function(data){
			 
			totalPrice=data.data.data.totalprice;
			GetDateNow(totalPrice);
         })
	}
	...
	function GetDateNow(a) {
		...
		document.getElementById("WIDout_trade_no").value = ono;
		document.getElementById("WIDtotal_amount").value = a;
		document.getElementById("WIDsubject").value = "电子产品";
